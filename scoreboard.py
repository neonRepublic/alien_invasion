...
class Scoreboard:
    ...
    def show_score(self):
        """places score, level and ships lives on screen"""
    ...
    def prep_level(self):
        """changes level into image"""
        level_str = str(self.stats.level)
        self.level_image = self.font.render(level_str, True,
                                            self.text_color, self.settings.bg_color)
        
        #positions level below score
    ...
    def prep_ships(self):
        """shows how many ship lives are left for player"""
        self.ships = Group()
